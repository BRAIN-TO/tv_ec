...
def spm_nlsi_GN(M, U=[], Y={}):
    ...
    nr = int(ny / ns)  # number response components
    ...
    try:
        ...
        Q = spm.Ce(((ns * ones((1, nr))).astype(int))[0,:])  # TODO: test this
    ...
    # sss = spm.diag([pC, uC])
    # print(sss[0][0].shape, sss[1][1].shape, spm.cat(spm.diag([pC, uC])).shape)
    # print(abcd)
